...
import { View, Text, TouchableHighlight, Image, ScrollView, FlatList, Modal } from "react-native";
...
export default class SoccerScreen extends Component {
    ...
    render() {
        return (
            <View>
                <Text style={{ fontWeight: "700", textAlign: "center" }}>List view horizontal</Text>
                <FlatList
